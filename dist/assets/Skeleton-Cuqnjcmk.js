import{F as e,P as t,R as n,St as r,Tt as i,W as a,_t as o,et as s,gt as c,nt as l,tt as u,vt as d}from"./client-D2Czp0ta.js";function f(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||``}function p(e){return parseFloat(e)}var m=i(r(),1);function h(e){return u(`MuiSkeleton`,e)}s(`MuiSkeleton`,[`root`,`text`,`rectangular`,`rounded`,`circular`,`pulse`,`wave`,`withChildren`,`fitContent`,`heightAuto`]);var g=c(),_=e=>{let{classes:t,variant:n,animation:r,hasChildren:i,width:o,height:s}=e;return a({root:[`root`,n,r,i&&`withChildren`,i&&!o&&`fitContent`,i&&!s&&`heightAuto`]},h,t)},v=d`
  0% {
    opacity: 1;
  }
