import{$ as e,I as t,M as n,N as r,U as i,_t as a,et as o,gt as s,ht as c,tt as l,wt as u,xt as d}from"./authStore-C1O5o-jR.js";function f(e){return String(e).match(/[\d.\-+]*\s*(.*)/)[1]||``}function p(e){return parseFloat(e)}var m=u(d(),1);function h(e){return o(`MuiSkeleton`,e)}e(`MuiSkeleton`,[`root`,`text`,`rectangular`,`rounded`,`circular`,`pulse`,`wave`,`withChildren`,`fitContent`,`heightAuto`]);var g=c(),_=e=>{let{classes:t,variant:n,animation:r,hasChildren:a,width:o,height:s}=e;return i({root:[`root`,n,r,a&&`withChildren`,a&&!o&&`fitContent`,a&&!s&&`heightAuto`]},h,t)},v=a`
  0% {
    opacity: 1;
  }
